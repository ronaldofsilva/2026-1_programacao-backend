...
public class PhotoController {
    ...
    public PhotoController(PhotoService service, PeopleService peopleService) {
    ...
    public ResponseEntity<List<PhotoResponseDTO>> listarTodos() {
        return ResponseEntity.ok(photoService.listarTodos());
    }
    ...
    public ResponseEntity<?> salvar(
        ...
        try {
            ...
            PhotoResponseDTO newPhoto = photoService.uploadAndSave(file, photoMetadata);
    ...
    public ResponseEntity<?> alterar(
            ...
            @RequestParam("photo") MultipartFile file) {
        try {
            Photo updatedPhoto = photoService.replaceFile(id, file);
    ...
    public ResponseEntity<List<PhotoResponseDTO>> buscarPorPessoa(@PathVariable String peopleId) {
        List<PhotoResponseDTO> photos = photoService.buscarPorPessoa(peopleId);
